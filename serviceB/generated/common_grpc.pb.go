...
const (
	GreeterService_SayHello_FullMethodName = "/serviceA.GreeterService/SayHello"
)
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "serviceA.GreeterService",
...
const (
	StatusService_ReportStatus_FullMethodName = "/serviceA.StatusService/ReportStatus"
)
...
func (c *statusServiceClient) ReportStatus(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedStatusServiceServer) ReportStatus(context.Context, *StatusRequest) (*StatusResponse, error) {
...
func _StatusService_ReportStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServiceServer).ReportStatus(ctx, req.(*StatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StatusService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "serviceA.StatusService",
